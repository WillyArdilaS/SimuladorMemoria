...
const Performance = ({memorySize, blockSizesReverse, activeFiles}) => {
    ...
    const calculateActualBlock = (file) => {
        return (blockSizesReverse[activeFiles.findIndex(data => data == file)]);
    }
                        ...
                        <section className="w-3/4 ml-10 flex flex-col">
                            {
                                performanceFiles.map(file => (
                                    <section className="h-5 my-2.5 bg-darkGray flex">
                                        ...
                                        <div className="h-full bg-yellow" style={{width: calcultePerc(calculateActualBlock(file) - file.memoriaUsar, 490)}}> </div>
                                    </section>
                                ))
                            }
                        </section>
