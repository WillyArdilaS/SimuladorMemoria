                    ...
                    <section className="px-2 pt-2 pb-10 border-x-2 border-b-2 border-darkGray font-paragraph flex"> 
                        ...
                        <section className="w-3/4 ml-10 flex flex-col">
                            <section className="h-5 my-2.5 bg-darkGray flex">
                                <div className="h-full bg-blue" style={{width: 50}}> </div>
                                <div className="h-full bg-yellow" style={{width: 10}}> </div>
                            </section>
                                
                            <section className="h-5 my-2.5 bg-darkGray flex">
                                <div className="h-full bg-blue" style={{width: 20}}> </div>
                                <div className="h-full bg-yellow" style={{width: 10}}> </div>
                            </section>
                                
                            <section className="h-5 my-2.5 bg-darkGray flex">
                                <div className="h-full bg-blue" style={{width: 35}}> </div>
                                <div className="h-full bg-yellow" style={{width: 40}}> </div>
                            </section>
                        </section>
