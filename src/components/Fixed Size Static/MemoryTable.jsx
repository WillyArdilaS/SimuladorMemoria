        ...
        <table className="border-collapse text-darkGray font-paragraph">
            ...
            <tbody>
                <tr>
                    ...
                    <td className="px-4 py-2 border-x-2 border-t-2 border-darkGray text-transparent"> {blockSize} </td>
                ...
                <tr>
                    ...
                    <td className="px-4 py-2 bg-blue border-x-2 border-y-2 border-darkGray text-center text-sm"> {blockSize} </td>
